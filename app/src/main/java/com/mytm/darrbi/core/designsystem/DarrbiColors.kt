...
data class DarrbiColors(
    ...
    /** Label on the active (green) mode segment — dark, since [modeAccent] is bright. */
    val onModeAccent: Color,
    /** Grey track behind the RIDER/CAPTAIN toggle. */
    val modeTrack: Color,
    /** Label on the inactive (grey) mode segment. */
