...
/**
 * Named text styles. Styles carry font/weight/size only — NOT color (color is applied by the composable
 * from [DarrbiTheme.colors] so dark mode and theming work). The [FontFamily] is locale-aware
 * (see [appFontFamily]); typography is rebuilt when the locale changes.
 */
@Immutable
