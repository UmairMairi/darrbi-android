...
/**
 * Semantic color tokens for the app. Ported verbatim from the Android module's design system — pure Compose,
 * so it compiles unchanged on Android + iOS. Raw [Color] literals live ONLY here; UI reads via [DarrbiTheme].
 */
@Immutable
data class DarrbiColors(
    ...
    val onModeAccent: Color,
    val modeTrack: Color,
    val onModeTrack: Color,
...
val LightDarrbiColors = DarrbiColors(
    ...
    onModeAccent = NearBlack,
    modeTrack = Color(0xFF8E8E8E),
    onModeTrack = White,
