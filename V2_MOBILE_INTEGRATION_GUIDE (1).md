...
//             { "ok": false, "error": { "code": "PAYMENT_HOLD_FAILED", "message": "PAYMENT_HOLD_FAILED" } }
//
...
| 2 | GET | `/v2/trips/open-in-range?cabId=&lat=&long=` | Driver | — | `{ ok, data:{ trips:[ {…, rider:{…} } ] } }` |
...
| 5 | GET | `/v2/trips/:tripId/bids` | Rider | — | `{ ok, data:{ bids:[ {…, driver:{…} } ] } }` |
